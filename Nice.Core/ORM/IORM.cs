...
namespace Nice
{
    ...
    /// 3.对某些易出错的写法(如不写Select,滥用SingleOrDefault)进行封装和限制,帮助业务开发人员发现逻辑错误,或从技术上(一定程度)避免他们写出错误的逻辑代码
    ...
    public interface IORM
    {
        ...
        /// 1.从代码层面做读写分离=>成本最低
        /// </remarks>
        IReadOnlyQueryable<TSource> ReadOnlySet<TSource>() where TSource : class, IEntitybase;
    }
}